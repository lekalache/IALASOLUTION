...
PROXIO_WELCOME_TEXT: 'Bienvenue chez IALASOLUTION !<br>Découvrez nos solutions de conseil et de formation pour booster votre réussite.<br>Commencez maintenant !',    PROXIO_HERO_ENABLE: true, 
    ...
    PROXIO_FEATURE_TITLE: 'Pourquoi travailler avec nous ?',
    PROXIO_FEATURE_TEXT_1: 'Nous voulons faire briller votre projet',
    PROXIO_FEATURE_TEXT_2: 'Riche expérience de cas, service technique professionnel, efficacité de communication de qualité',

    PROXIO_FEATURE_1_ICON_CLASS: 'fa-solid fa-stopwatch', 
    PROXIO_FEATURE_1_ICON_IMG_URL: '/avatar.png', // fas /avatar.png
...
PROXIO_CAREERS: [
    ...
    PROXIO_TESTIMONIALS_TEXT_2: 'Des milliers de webmasters choisissent NotionNext pour construire leurs sites web. Grâce aux manuels d\'aide, aux communautés d\'échange et aux consultations techniques, tout le monde a réussi à mettre en ligne son site web',
    ...
    PROXIO_POST_REDIRECT_URL: 'https://ialasolution.com', 
    PROXIO_NEWSLETTER: process.env.NEXT_PUBLIC_THEME_PROXIO_NEWSLETTER || false // mailchimp  https://docs.tangly1024.com/article/notion-next-mailchimp
}
