...
const BLOG = {
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'fr-FR', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WeshAlors', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'WeshAloors', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ialasolution.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, IALASOLUTION', // 网站关键词 英文逗号隔开
